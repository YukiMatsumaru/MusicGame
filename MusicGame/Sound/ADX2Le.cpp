...
CriAtomExVoicePoolHn	ADX2Le::m_standard_voice_pool;	// ボイスプール(ADX/HCAコーデック用)
CriAtomExVoicePoolHn	ADX2Le::m_hcamx_voice_pool;		// ボイスプール(HCA-MX用)
CriAtomDbasId			ADX2Le::m_dbas_id;				// D-BASハンドル
ADX2Le_Player			ADX2Le::m_player;				// プレイヤーハンドル
